...
1: Download the file from Release section: https://github.com/kartikhunt3r/AdrishyaReconDorker/releases/download/v1.0/AdrishyaRecon.exe

2: Run the EXE file

3: Enter the target domain

4: Click on different buttons in the tool to find information

5: In case of Google Captcha simply click on the puzzle and move ahead



### Linux:

1: Download the file from Release section: https://github.com/kartikhunt3r/AdrishyaReconDorker/releases/download/v1.0.0/AdrishyaRecon

2: 
```bash
chmod +x AdrishyaRecon
```

3: run the AdrishyaRecon file.(by double click or ./AdrishyaRecon)

4: Enter the target domain

5: Click on different buttons in the tool to find information

6: In case of Google Captcha simply click on the puzzle and move ahead
